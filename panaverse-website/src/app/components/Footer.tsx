              ...
              >
                <Box pt={"10px"} height={"80px"}>
                  <Link
                    ...
                    target="_blank"
                  >
                    <Heading color="gray" pb={"10px"}>Karachi</Heading>
                  </Link>
                ...
                <Box pt={"10px"} height={"80px"}>
                  <Link
                    ...
                    target="_blank"
                  >
                    <Heading color="gray" pb="10px">Lahore</Heading>
                  </Link>
                  <AspectRatio ratio={16 / 9}>
                ...
                <Box pt={"10px"} height={"80px"}>
                  <Link
                    ...
                    target="_blank"
                  >
                    <Heading color="gray" pt={"25px"}>Islamabad</Heading>
                  </Link>
                  <AspectRatio ratio={16 / 9}>
                ...
                <Box pt={"10px"} height={"80px"}>
                  <Link
                    ...
                    target="_blank"
                  >
                    <Heading color="gray" pt={"25px"}>Peshawar</Heading>
                  </Link>
                  <AspectRatio ratio={16 / 9}>
