import { AspectRatio, Box, Center, Container, Grid, Heading, HStack, SimpleGrid, Stack, Text, VStack, Wrap, WrapItem } from '@chakra-ui/react'
        ...
        {/* <SimpleGrid textAlign={{lg:'start',base:'center'}} spacing='30px' py='60px' templateColumns={{base:'repeat(1, 1fr)', lg:'repeat(4, 1fr)'}}> */}
            ...
            {/* // templateColumns= {{base: 'repeat(2, 1fr)', lg: 'repeat(4, 1fr)'}}> */}
                <Box>
                    ...
                    <Image m={{base:'auto', lg:'0'}} src='panaverseLogo.png' alt='Panaverse Logo'></Image>
                    ...
                    <Heading pb={'10px'}>Karachi</Heading></Link>
                        ...
                        <Box pt={'10px'} height={'80px'}>
                            <Link href={"https://goo.gl/maps/imiecfbr6fRQ7bgV8"} target='_blank'>
                                <Heading pt={'25px'}  >Islamabad</Heading></Link>
                        <AspectRatio ratio={16 / 9}>
                        ...
                        <Box pt={'10px'} height={'80px'}>
                            <Link href={"https://goo.gl/maps/D5SaaiosredE6vSu7"} target='_blank'>
                                <Heading pt={'25px'} >Peshawar</Heading></Link>
                        <AspectRatio ratio={16 / 9}>
